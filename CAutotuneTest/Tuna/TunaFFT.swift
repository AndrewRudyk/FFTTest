...
struct TunaFFT {
    ...
    static func transform(buffer: AVAudioPCMBuffer) throws -> Buffer {
    ...
    static func fft(buffer: AVAudioPCMBuffer) throws -> Buffer {
    ...
    private static func sqrtq(_ x: [Float]) -> [Float] {
